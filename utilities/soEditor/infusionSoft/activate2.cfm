...
<cfinvoke component="utilities/XML-RPC"
    ...
    <cfif not ArrayIsEmpty(theData.PARAMS[1])>
        ...
        <!---
        	<cfquery name="InsertSchool" datasource="wellcoachesSchool" username="#application.DSNuName#" password="#application.dsnpword#" >
                INSERT INTO [wellcoachesSchool].[dbo].[members]
                 ( 
                 firstName,
                 lastname,
                 StartDate,
            ...
            <cftransaction>
           <!--- <cfquery name="GetNextIDForBanned" datasource = "#DSN#" username="#application.DSNuName#" password="#application.dsnpword#" >
                select max(MemberID) as NewID from [wellcoachesSchool].[dbo].[members]
            </cfquery>
            
            <cfset bannedID = #GetNextIDForBanned.NewID#>--->
    ...
    <!---to="#URL.email#--->    
    <cfmail from="techsupport@wellcoaches.com" to="#URL.email#" subject="WellCoaches Account activation" type="html">  
