<cfcomponent>
	...
	<cffunction name="AddCustomer" access="remote" returntype="numeric" output="true">
		...
		<CFSET FieldValues = "#CardName#,#active#,#CCExpire#,#CCNo#,#CCType#,#OnMailList#,#startdate#,#firstname#,#lastname#,#username#,#password#,#AffiliateID#,#resellerstate#,#resellernumber#">
	...
	<cffunction name="GetAllCustomer" access="remote" output="true" returntype="query">
		...
		<cfif #tCustomer.recordcount# gt 0>
			...
			<cfreturn Customer>
		<cfelse>
			<cfset Customer=querynew("CardName,Active,CCExpire,CCNo,CCType,OnMailList,StartDate,firstname,lastname,username,password,AffiliateID,resellerstate,resellernumber,companyname,displayname,websiteurl,typeid,pricingid")>
		</cfif>
		<cfreturn Customer>
	</cffunction>
