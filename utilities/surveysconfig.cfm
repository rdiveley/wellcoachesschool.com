 <cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
  ...
  <cfinvokeargument name="FileName" value="SurveysConfig">
...
<cfif #TheFileExists# is "true">
  <cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
    ...
    <cfinvokeargument name="ThisFileName" value="SurveysConfig">
    <cfinvokeargument name="IDFieldName" value="SurveysConfigID">
...
<cfif isDefined('form.submit')>
  ...
  <cfif #TheFileExists# is "true">
    <cfinvoke component="#Application.WebSitePath#.utilities.xmlhandler" method="UpdateXMLRecord">
      ...
      <cfinvokeargument name="XMLIDField" value="SurveysConfigID">
...
<cfoutput> <h1>Surveys Configuration</h1> <br>
    ...
    <center>
      <table>
        <tr> 
          <td valign="top"> <table>
              <tr> 
                  <td>Allow Users to create surveys?</td>
              ...
              <tr> 
                  <td>Connect All Surveys to the Discussion Board?</td>
