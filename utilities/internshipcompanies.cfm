...
<cfif TypeAction is "delete">
	<cfinvoke component="#Application.WebSitePath#.utilities.xmlhandler" method="DeleteXMLRecord">
		...
		<cfinvokeargument name="ThisFileName" value="internshipcompanies">
...
<TABLE>
	...
	<select name="positionid">
		<cfloop index="i" from="1" to="100">
			<option value="#i#"<cfif #i# is #int(positionID)#> selected</cfif>>#i#</option>
		</cfloop>
	</select>
	</TD>
	</TR>
...
<cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
	method="CheckFileExists" returnvariable="TheFileExists">
		<cfinvokeargument name="FileName" value="internshipcompanies">
		<cfinvokeargument name="ThisPath" value="files">
</cfinvoke>	

<cfif #TheFileExists# is "true">
	<cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
		method="GetXMLRecords" returnvariable="Allinternshipcompanies">
		<cfinvokeargument name="ThisPath" value="files">
		<cfinvokeargument name="ThisFileName" value="internshipcompanies">
...
<cfoutput query="Allinternshipcompanies">
<tr>
<td><p>#TypeID#</p></td>
<td><p>#TypeName#</p></td>
