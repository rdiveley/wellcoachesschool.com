...
<cfloop query="surveyList">
	...
	<cfif name contains url.email>
         ...
         <cfoutput><tr><td><a href="#cgi.SCRIPT_NAME#?fileName=#URLEncodedFormat(ReplaceNoCase(surveyList.name,"^","_","all"))#" style="font-family:Arial, Helvetica, sans-serif;size:auto; text-decoration:none">#ListGetAt(URLDecode(surveyList.name),1,"_")# Wellbeing Assessment</a></td></tr></cfoutput>
    </cfif>
</cfloop>
</table>
<cfif !foundOne>
