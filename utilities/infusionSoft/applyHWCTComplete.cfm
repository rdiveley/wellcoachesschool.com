...
<!---<cfif thisTag.executionMode is "start" >--->
   ...
   <cfmodule template="inc/core/july2018.cfm" memberid="#attributes.memberid#" tagList="#tagList#" />
   <cfmodule template="inc/core/sept2018.cfm" memberid="#attributes.memberid#" tagList="#tagList#" />
   <cfmodule template="inc/core/nov2018.cfm" memberid="#attributes.memberid#" tagList="#tagList#" />
...
<!-- 2. if the user has either firsttag or secondTag, then we apply the firsttag to their account -->
   <cfloop list="#group1#" index="class">
        ...
        <cfset postClass = "HWCT_#listFirst(class,'_')#_trained" />
  		...
  		<cfset preClass = listFind(tagList,firstTag)/>
  	 	<cfset postClass = listFind(tagList,secondTag)/>
