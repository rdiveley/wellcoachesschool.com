...
<cfif structKeyExists(form, 'survey')>
    ...
    <cfset coachName = ListRemoveDuplicates(coachName, " ") />
        ...
        <CFX_HTTP5
          url="https://restapi.surveygizmo.com/v4/survey/#form.survey#/surveyresponse/?api_token=b372e5a8eef26991d36bbebb354d285defb60f913b0f645aca&#local.body#"
          method="get"
	 ...
	 <cfif structKeyExists(jsonData,'data') and NOT arrayIsEmpty(jsondata.data)>
        ...
        <cfloop array="#jsonData.data#" index="field">
          <cfset queryAddRow(SurveyList)>
            ...
            <cfset temp = QuerySetCell(SurveyList,"q5",field['[question(6)]'])/> 
