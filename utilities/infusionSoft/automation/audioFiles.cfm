...
<p style="color:red;font-size:20px">
    *Wellcoaches will accept all class on this page for credit towards recertification.  Each class is worth 1 CEU<br />
    *Current year class recordings are approved by a few outside organizations.  Please look under the "Approved courses by CE providers column" to see which organizations approves each class<br />
    *All classes are worth 1 CEU<br />
    *Please complete all requirements for the class to receive CE’s (requirements listed in the “requirements for CE’s” column.  
    </p>
