		...
		<div class="container">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
				    ...
				    <form accept-charset="UTF-8" action="https://my982.infusionsoft.com/app/form/process/da7bf1eb9d25eba1bc0b0eb3fa7e8b7a" class="form-inline" method="POST">
...
<footer>
    <div class="container">
         ...
         <div class="col-sm-12  col-md-8 col-lg-4 social text-right pull-right">
            ...
            <a href="https://twitter.com/coachmeg" class=""><img src="#$.siteConfig('themeAssetPath')#/assets/bootstrap/images/social-twitter.png" alt="Well coaches twitter"></a>
