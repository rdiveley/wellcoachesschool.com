...
<div style="min-width:<cfoutput>#templatewidth#</cfoutput> !important">
	<div id="header_container">
        <div id="header">
            <div class="left">
            	<a href="/"><img style="width: 100%;" src="/default/images/oym/wellcoaches.gif" /></a>
            </div>
            <div class="right">
				<p>An organized mind is intentional, deep, agile, diverse, and energized. It's productive, creative, and strategic &#8212; every day.</p>
				<span id="login"> <a href="/login"><img src="/default/images/oym/oym_login_btn.png" /></a></span>
            </div>
        </div>
...
<div style="margin-right:300px !important;margin-left:300px">#$.content('Section1')#</div>
<div style="clear: both;"></div>
<div style="margin: 0px 300px 0px 300px">#$.content('Section2')#</div>
<div style="margin: 0px 300px 0px 300px">#$.content('Section3')#</div>
<div style="margin: 0px 300px 0px 300px">#$.content('Section4')#</div>
<div style="margin: 0px 300px 0px 300px">#$.content('Section5')#</div>
<div style="margin: 0px 300px 0px 300px">#$.content('Section6')#</div>
<div style="margin: 0px 300px 100px 300px !important">#$.content('Section7')#</div>
<cfif len($.dspObjects(2))>
	#$.dspObjects(2)#
</cfif>	
</cfoutput>
