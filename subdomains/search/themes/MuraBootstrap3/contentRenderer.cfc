...
<cfcomponent extends="mura.cfobject">
	...
	<cffunction name="dspCrumblistLinks"  output="false" returntype="string">
		  ...
		  <cfif arrayLen(this.crumbdata) gt (2 + this.navOffSet)>
		      <cfsavecontent variable="theNav">
		          <cfoutput>
		              <cfloop from="#theOffset#" to="1" index="I" step="-1">
		                  <cfif I neq 1>
			                  <cfif this.crumbdata[I].menutitle NEQ "Home">
		                      	<li> #addlink(this.crumbdata[I].type, this.crumbdata[I].filename, this.crumbdata[I].menutitle, '_self', '', this.crumbdata[I].contentid, this.crumbdata[I].siteid, '', application.configBean.getContext(), application.configBean.getStub(), application.configBean.getIndexFile(), event.getValue('showMeta'),0)#</li>
		                  	  </cfif>
		                  <cfelse>
		                      <li class="active">
