									 ...
									 <div class="col-sm-6 col-md-4">
										<div>
								           <a href="#item.getButtonLink()#">
								            <img class="img-responsive" src="#item.getImageURL()#" alt="" width="1000" height="550" style=" padding-bottom: 25px;" >
								            <span class="carousel-caption">
									        <br />
								            <p style="font-family:'Ubuntu', 'Helvetica Neue', Helvetica, Arial, sans-serif;">#item.getHeader()#</p>
								            <hr>
								            <p>#item.getTagLine()#</p>
								            </a>
								            </span>
					...
					<cfset item=iterator.next()>
			           <cfset idx++>
			              ...
			              <div class="col-md-9">
			                 ...
			                 <p>#item.getTagLine()#</p>
			                 <p><a class="btn btn-primary" href="#item.getButtonLink()#" target="_blank" role="button">#item.getButtonText()#</a></p>
			                </div>
			              </div>
			              </div>
			            </div><!-- end item -->
