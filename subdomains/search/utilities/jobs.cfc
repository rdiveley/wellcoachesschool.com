	...
	<cffunction name="JobsAdmin" access="remote" returntype="string" output="true">
		...
		<TABLE>
			...
			<select name="contactstate">
				<cfloop query="AllStates">
					<option value="#AllStates.StateID#" <cfif #ListFind(trim(contactstate),AllStates.StateID,"~")#>selected</cfif>>#stateName#</option>
				</cfloop>
				<OPTION value="999" <cfif #ListFind(trim(contactstate),"999","~")#>selected</cfif>>Nationwide</OPTION> 
				<OPTION value="Australia" <cfif #ListFind(trim(contactstate),"Australia","~")#>selected</cfif>>Australia</OPTION>
				<OPTION value="Canada" <cfif #ListFind(trim(contactstate),"Canada","~")#>selected</cfif>>Canada</OPTION> 
				<OPTION value="United Kingdom" <cfif #ListFind(trim(contactstate),"United Kingdom","~")#>selected</cfif>>United Kingdom</OPTION>
				<OPTION value="Other Countries" <cfif #ListFind(trim(contactstate),"Other Countries","~")#>selected</cfif>>Other Countries</OPTION>
			</select>
			</td>
