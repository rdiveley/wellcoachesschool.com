...
<cfoutput>
  ...
  <cfset allsurveys = "1013764,1020531,1120644,1060665,1330743,1117522,1026874,1117550,1447572,1144369">
					...
					<cfif !listFind(NoHours,surveyTitle)>
                        <td>
                            ...
                            <cfelseif surveyTitle eq 1117550>
                                7.5    
								<cfset total = total + 7>
                            <cfelseif surveyTitle eq 1026874>
