...
<div class="datagrid"  style="overflow:scroll;height:500px;overflow-x:hidden" >
<form name="WellcoachesMemberClasses" action="#action#" id="WCMC" method="post">
 ...
 <table >
	<thead>
        <tr>
            ...
            <th width="5">Member<br/>Class Title</th>
            <th width="5">Facilitator/<br/> Author</th>
            <th width="20">Handout(s)<br/> Link</th>
            <th width="100">Listen Link </th>
  ...
  <tbody>
        <cfloop query="listFiles"> 
            <tr id="show_row_#id#" bgcolor="###iif(currentrow MOD 2,DE('ffffff'),DE('efefef'))#">
                <td width="5"><span id="show_category_#id#">#category#</span></td>
                <td width="5"><span id="show_class_title_#id#">#class_title#</span></td>
                <td width="5"><span id="show_facilitator_#id#">#facilitator#</span></td>
                <td><span id="show_handout_link_#id#">#handout_link#</span></td>
                <td nowrap="nowrap"><span id="show_listen_link_#id#">#listen_link#</span></td>
                <td nowrap="nowrap"><span id="show_download_link#id#">#download_link#</span></td>
                <cfif structKeyExists(URL,'cip')>
                	<td width="5"><span id="show_cceh_#id#">#cceh#</span></td>
