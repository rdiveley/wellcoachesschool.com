...
<cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
	method="GetXMLRecords" returnvariable="AllPhotoCategories">
...
<TABLE>
	...
	<TR>
	<TD valign="top"> ## of Photos in this category: </TD>
    <TD>
...
<cfoutput><a href="adminheader.cfm?Action=#Action#&CategoryAction=Add">Add A New Gallery Category</a></cfoutput><br>
	<cfinvoke component="#Application.WebSitePath#.utilities.XMLHandler" 
		method="CheckFileExists" returnvariable="TheFileExists">
			<cfinvokeargument name="FileName" value="PhotoCategories">
			<cfinvokeargument name="ThisPath" value="files">
	</cfinvoke>	
	...
	<th colspan="5" align="CENTER" bgcolor="Maroon"><p>Your Gallery Categories</p></th>
	<tr>
	<td><p>ID</p></td>
	...
	<cfoutput query="AllPhotoCategories">
	<tr>
