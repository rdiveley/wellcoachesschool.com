	...
	4228 did not pass--->
     ...
     <cfinvoke component="utilities/XML-RPC"
         ...
         <cfhttp method="post" url="https://my982.infusionsoft.com/api/xmlrpc" result="myResult">
          ...
          <cfmail to="#URL.examiner_email#;#URL.concierge#;" subject="Practical Exam Results - Pass" from="wellcoaches@wellcoaches.com" type="html">
               ...
               <br />
               To view results, click <a href="https://wellcoachesschool.com/utilities/infusionsoft/practicalResults.cfm?showPracticalResults=1&student_email=#URL.student_email#"> Results </a>
          </cfmail>
