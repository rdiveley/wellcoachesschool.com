<cfif !structKeyExists(attributes,'runstep')>
    <cfif listFindNoCase(attributes.tagList,9921) 
        AND listFindNoCase(attributes.tagList,9899) >
...
<cfif listFindNoCase(attributes.tagList,9893) 
    AND (listFindNoCase(attributes.tagList,9895) OR structKeyExists(local,'tag9895'))>
    <!-- [Res Aug2018 [Indy] Mod 1 ALL Surveys Complete -->
      <cfset myArray = ArrayNew(1)>
      <cfset myArray[1]="ContactService.addToGroup">
      <cfset myArray[2]="fb7d1fc8a4aab143f6246c090a135a41">
      <cfset myArray[3]="(int)#attributes.memberID#">
      <cfset myArray[4]="(int)9897">
