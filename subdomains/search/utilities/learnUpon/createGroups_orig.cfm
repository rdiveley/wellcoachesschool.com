...
<!--- 1. add the Learn Upon group IDs here --->
 <cfset local.group_id = "86550,92767,121229,122134,122751,124692,132795,132796,133227,134579">
		...
		<cfif !len(local.id)>
			...
			<cfif structKeyExists(local.messgeStruct,'message') AND local.messgeStruct.message contains 'user already exists'>
				...
				<cfmail to="#local.concierge#,mthom@wellcoaches.com" from="techsupport@wellcoaches.com" subject="LearnUpon Portal Invite" type="html">
					User: #local.userInfo['firstName']# #local.userInfo['lastName']# email: #URL.email# <br /><br />
					<p>Has been invited to the LearnUpon Portal, please follow up to ensure they are added correctly.</p>
					<p>Thank you</p>
				</cfmail>
