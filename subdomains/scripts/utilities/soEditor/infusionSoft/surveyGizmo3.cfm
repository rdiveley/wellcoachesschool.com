...
<cfinvoke component="utilities/XML-RPC"
  ...
  <cfquery name="insertResults" datasource="#DSN#" username="#application.DSNuName#" password="#application.dsnpword#" >
  	INSERT INTO profCoachOct2012
    (lesson,email,faculty,coachingSkills,valuableSkills,facultyExpertise,summarize,awareOf,dateSubmitted,infusionSoftID)
    VALUES
    (
  ...
  <cfcatch type="any">
  <cfmail to="techsupport@wellcoaches.com" subject="Survey Gizmo 3 Error" from="#URL.email#">
  	#cfcatch.detail#<br />
    <cfdump var="#URL#">
  </cfmail>
  </cfcatch>
