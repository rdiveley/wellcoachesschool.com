...
<cfinvoke component="utilities/XML-RPC"
  ...
  <cfquery name="insertResults" datasource="#DSN#" username="#application.DSNuName#" password="#application.dsnpword#" >
            ...
            (hours,lesson,email,classTitle,coachingSkills,faculty,valuableSkills,summarize,awareOf,dateSubmitted,infusionSoftID)
            VALUES
            (
                 <cfif show>
                	<cfqueryparam value="1.5" cfsqltype="cf_sql_float"/>
                 <cfelse>
  ...
  <cffile action="write"
   ...
   <cffile action="readbinary" file="#expandPath('./temp/#uniqueFileName#')#" variable="readFile">
    ...
    <cfif URL.email Contains "_">
        ...
        <cflocation url="completedHours_1.cfm?email=#URL.email#&lesson=#lessonNumber#"   >     
