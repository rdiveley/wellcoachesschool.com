<cfif !structKeyExists(attributes,'runstep')>
    <cfif listFindNoCase(attributes.tagList,13091) AND listFindNoCase(attributes.tagList,13119) >
        ...
        <cfset myArray[4]="(int)13113">
            ...
            <cfset local.tag13113 = 1 />
    </cfif>
</cfif>    

<cfif (listFindNoCase(attributes.tagList,13113) OR structKeyExists(local,'tag13113'))
        AND listFindNoCase(attributes.tagList,13111) >
    <!-- [Res Aug2018 [Indy] Mod 1 Four-Day Surveys Complete  -->
      <cfset myArray = ArrayNew(1)>
      <cfset myArray[1]="ContactService.addToGroup">
      <cfset myArray[2]="fb7d1fc8a4aab143f6246c090a135a41">
