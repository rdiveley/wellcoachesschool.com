<cfif !structKeyExists(attributes,'runstep')>
    <cfif listFindNoCase(attributes.tagList,17420) AND listFindNoCase(attributes.tagList,17418) >
        ...
        <cfset myArray[4]="(int)16874">
            ...
            <cfset local.tag16874 = 1 />
    </cfif>
</cfif>    

<cfif (listFindNoCase(attributes.tagList,16874) OR structKeyExists(local,'tag16874'))
        AND listFindNoCase(attributes.tagList,16876) >
    <!-- [Res Aug2018 [Indy] Mod 1 Four-Day Surveys Complete  -->
      <cfset myArray = ArrayNew(1)>
      <cfset myArray[1]="ContactService.addToGroup">
      <cfset myArray[2]="fb7d1fc8a4aab143f6246c090a135a41">
