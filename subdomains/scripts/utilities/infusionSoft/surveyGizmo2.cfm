...
<cfset local.lesson = URLEncodedFormat(URL.classAttended)>
...
<cfset uniqueFileName = "#local.email#_#classAttended# #local.lesson# #year#_#dateFormat(now(),'mm-dd-yyyy')#.pdf">
