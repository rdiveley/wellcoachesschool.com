            ...
            <td>
                <form name="form1" method="post" enctype="multipart/form-data" onsubmit="return PassFileName()" >
                   ...
                   <!--- <p>
                    ...
                    <cfset endYear = currentYear> <!--- Ending year --->
                    <cfset seasons = [
                         { "name" = "Fall", "monthDay" = "11-30" },
                          { "name" = "Summer", "monthDay" = "07-31" },
                        { "name" = "Spring", "monthDay" = "04-30" }
                         ...
                         <select name="examDate" id="examDate">
                            ...
                            <cfoutput>
                                <cfloop from="#endYear#" to="#startYear#" index="year" step="-1">
                                    <cfloop array="#seasons#" index="season">
                                        <option value="#season['monthDay']#-#year#">#season['name']# #year#</option>
                                    </cfloop>
                                </cfloop>
                            </cfoutput>
                        </select>
