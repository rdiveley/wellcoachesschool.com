	...
	<body scroll="no" style="OVERFLOW: hidden">
		<div id="divInfo" style="DISPLAY: none">
			...
			<select id="cmbLinkType" onChange="SetLinkType(this.value);">
				...
				<option value="internalpage" fckLang="DlgLnkTypePage">Internal Page</option>
			</select>
			<br />
			<br />
			...
			<div id="divLinkTypePage" style="DISPLAY: none">
				<span fckLang="DlgLnkPage">Select Internal Page</span><br />
				<select name="cmbPageAnchor">
					<option value="index.cfm">--- Select ---</option>
					<cfoutput query="allpages">
						<option value="#replace(application.returnpath,'http://','')#/index.cfm?Page=#pagename#">#pagename#
					</cfoutput>
				</select><br />
			</div>
		</div>
